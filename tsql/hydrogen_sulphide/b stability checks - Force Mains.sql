...
UPDATE [Conduit] SET solution_model = 'ForceMain', solution_model_flag = 'AD', us_headloss_type = 'FIXED', us_headloss_type_flag = 'AD', us_headloss_coeff = 0, us_headloss_coeff_flag = 'AD', ds_headloss_type = 'FIXED', ds_headloss_type_flag = 'AD', ds_headloss_coeff = 0, ds_headloss_coeff_flag = 'AD';