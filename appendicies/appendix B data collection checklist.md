...
| InfoNet data specification |  |  |  |  |  |  | Wellington Councils latest data specification for InfoNet (explains the titles applied to various user_text/number fields and explanations of some of the abbreviations set up in the fields – e.g. defect type codes and their meaning, INUS = In service, ABAN = Abandoned etc.) |
| InfoNet data flagging |  |  |  |  |  |  | Data flags meanings and colours |
| Manhole Survey Data |  |  |  |  |  |  | Surveys carried out by WCC are contained in the InfoNet database as 'manhole survey's |
| Manhole Survey Data (individual MH Cards) |  |  |  |  |  |  | Not available |
...
| Data Collection | Extent |  | Requested (Date) | From | Received (Date) | Source or filename/folder | Notes |
| --- | --- | --- | --- | --- | --- | --- | --- |
| Ancillary Structure as-built drawings |  |  |  |  |  |  |  |
| Pumping Station - Details |  |  |  |  |  |  | Manufacturer, make, model, impeller type, H/Q Curve and duty points |
| Pumping Station - Settings |  |  |  |  |  |  | Duty/Standby, Duty/Assist etc. Is duty pump switched after each cycle? |
| Pumping Station - Condition Assessment |  |  |  |  |  |  | Wet well inspections |
| Pumping Station - Condition Assessment |  |  |  |  |  |  |  |
| Pumping Station - Storage |  |  |  |  |  |  |  |
| Pumping Station - Upgrade Planning |  |  |  |  |  |  |  |
| Pumping Station - Drop Tests |  |  |  |  |  |  |  |
| Overflow surveys |  |  |  |  |  |  | Overflow manhole list |
| Flap Valves (non-return valves) |  |  |  |  |  |  | Location, size, material - which pipe is protected and from what (tide? River? Surcharge?) |
...
| Data Collection | Extent |  | Requested (Date) | From | Received (Date) | Source or filename/folder | Notes |
| --- | --- | --- | --- | --- | --- | --- | --- |
| Background Mapping |  |  |  |  |  |  | Mapinfo / ArcGIS (TAB/SHP) - roads/buildings/property boundary/coast/rivers/rail etc. |
| LIDAR or Contour Data |  |  |  |  |  |  | 2013 DEM |
| Aerial Photographs |  |  |  |  |  |  | ArcObjects server at WCC. This file can be viewed as a layer in InfoNet or ICM |
| River levels (models or flows) |  |  |  |  |  |  | For Interaction at overflow points, discharge locations or cover levels |
| Tidal Gauge Data (hourly) |  |  |  |  |  |  | For Interaction at overflow points, discharge locations or cover levels |
|  |  |  |  |  |  |  | CSV files available for download at hourly intervals |
| Tidal Gauge Data (observed) |  |  |  |  |  |  |  |
| Daily Tide Predictions |  |  |  |  |  |  | For Interaction at overflow points, discharge locations or cover levels |
| Ground water level |  |  |  |  |  |  |  |
